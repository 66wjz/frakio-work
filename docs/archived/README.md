<!-- wjz新建文件，新建原因：建立 docs/archived/ 归档索引 README.md，修改时间：2026-08-18。 -->
# 文档归档索引 (docs/archived/README.md)

> 本目录存放被正式文档吸收、取代或已完成实施的历史设计方案与旧版参考草案。
> 正式工程设计与开发以 `docs/` 根目录下的标准文档为准。
