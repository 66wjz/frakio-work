...
| **stage-2** | 分期开发计划 | [`docs/plan/分期开发计划.md`](file:///e:/80-project_dev/16_frakio-work(waiting%20github%20update)/docs/plan/分期开发计划.md) | `approved` | P0 架构治理、P1 调度编排、P2 飞书通道路线图。 |
